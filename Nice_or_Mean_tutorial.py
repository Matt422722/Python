...
def win(nice,mean,name):
    ...
    print("\nNice job {}, you win! \nEveryone loves you and you've \nmade lots of friends alone the way!".format(name))
    from PIL import Image
    # Open an image file
    image = Image.open("C:/myRepository/Stranger.webp")
    # Display the image in pop-out if the user wins the game
    image.show()
...
def again(nice,mean,name):
    stop = True
    while stop:
        choice = input("\nDo you want to play aagain? (y/n): \n>>> ").lower()
        if choice == "y":
            stop = False
